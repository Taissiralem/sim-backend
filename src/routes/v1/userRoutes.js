...
const {adminAuthAndRoleCheck, userAuthAndRoleCheck} = require("../../middlewares/authcheck");

// Define routes

router.put("/tour/:userId",userAuthAndRoleCheck, userController.updateUserTour);
...
router.get("/commandes/:userId",userAuthAndRoleCheck, userController.getUserCommandes);
